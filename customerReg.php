...
<div class="form-row">
	...
	Pincode <font color="#FF0000"> *</font>
	  <input type="" name="pincode" id="pincode" value="<?php echo $rsedit['pincode']; ?>" class="form-control">
	</div>

	<div class="col-md-6 form-group">
	Mobile Number <font color="#FF0000"> *</font>
	  <input type="" name="mblnum" id="mblnum" value="<?php echo $rsedit['mobile_no']; ?>" class="form-control">
	</div>
